...
<body>
		...
		<div class="content">
			...
			<div class="section group">				
				...
				<h2>
				  <p style="color:#FF0000;font-size:large"> Add Hospitals/<a href="adminviewhospital.php">View Hospital Details</a></h2>			
     ...
     <form name="form1" method="post" action="">
				    <table width="200" border="0">
				      <tr>
				        <td width="115">Hospital</td>
				        <td width="69"><label for="n"></label>
			            <input type="text" name="n" id="n" required="required"></td>
			          </tr>
				      <tr>
				        <td>Address</td>
				        <td><label for="add"></label>
			            <textarea name="add" id="add" cols="45" rows="5" required="required"></textarea></td>
			          </tr>
                      <tr>
				        <td>Contact NO</td>
				        <td><label for="p"></label>
			            <input type="text" name="p" id="p" maxlength="10" minlength="10" required="required" onBlur="chk3()"onKeyPress="return chk3()" ></td>
			          </tr>
...
{
$ins=mysql_query("insert into hospital (name,address,phone)values('$name','$add','$con')");
}
if($ins)
	{
