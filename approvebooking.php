...
<?php
	  $viewid=$_REQUEST['ID'];
	  $vtb=mysql_query("select Status from book where ID='$viewid'");
...
if(isset($_POST['submit']))
{
	...
	$upd=mysql_query("update book set Status='Approved' where ID='$viewid'");
if($upd)
{
	echo"<script>alert('You have successfully approved'); window.location='viewbooking.php';</script>";
}
else
{
	echo"mysql_error()";
