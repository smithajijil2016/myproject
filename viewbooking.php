...
$vtb=mysql_query("select * from book where Status='waiting'");
while($r=mysql_fetch_row($vtb))
{
	echo "<tr class='light'>
            ...
            <td><a href='approvebooking.php?ID=$r[0]'><font color='green'>Approve</font></a> | <a href='rejectbooking.php?ID=$r[0]'><font color='red'>Reject</font></a></td>
