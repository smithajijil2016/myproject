			...
			<div class="section group">				
				<div class="col span_1_of_3">
					<div class="contact_info">
			    	 		<div class="map">				  	
<img src="images/reject.jpg" width="300" height="256">
				...
				<div class="col span_2_of_3">
                  ...
                  <h1 style="font-size:large; color:#0066FF">Reject</h1>
                  <p style="font-size:large; color:#0066FF">&nbsp;</p> 
      <form name="form1" method="post" action="">
                  

<input name="s" type="submit" value="Reject">
	  ...
	  $viewid=$_REQUEST['ID'];
	   $ab=mysql_query("select * from register where ID='$viewid'");
	  $s=mysql_fetch_array($ab);
	  $vtb=mysql_query("select status from login where username='$s[username]'");
...
if(isset($_POST['s']))
{
	...
	$del=mysql_query("delete from register where username='$s[username]'");
		$del=mysql_query("delete from login where username='$s[username]'");

	if($del)
{
	echo"<script>alert('You have successfully rejected'); window.location='user.php';</script>";
}
else
{
	echo"mysql_error()";
