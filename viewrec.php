...
<body>
		...
		<div class="content">
			...
			<div class="section group">				
				...
				<div class="col span_2_of_3">
				  <div class="contact-form">    <h1 style="alignment-adjust:middle;font-size:large; color:#0066FF">Suggestions</h1>
    ...
    <form method="post" action="" enctype="multipart/form-data">
      ...
      <td>Place</td>
      <td>Suggested from</td>
      <td>Suggested to</td></tr>
      <?php
include("config.php");
$vtb=mysql_query("select * from suggestion");
