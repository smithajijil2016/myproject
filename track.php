...
<body>
		...
		<div class="content">
			...
			<div class="section group">				
				...
				<div class="col span_2_of_3">
				  <div class="contact-form">    <h1 style="alignment-adjust:middle;font-size:large; color:#0066FF">Ranking and Comments</h1>
    ...
    <form method="post" action="" enctype="multipart/form-data">
      ...
      <?php
include("config.php");
$vtb=mysql_query("select * from  rank");//ranking details
...
<?php 
 $sum=$r[4]+$r[3]+$r[1]+$r[2];//finding rating for place
 $rat=($sum/4);
