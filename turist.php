...
<body>
		...
		<div class="content">
			...
			<div class="section group">				
			  ...
			  <div class="col span_2_of_3"> <form method="post" action="" enctype="multipart/form-data">
     <marquee behavior="alternate"><font size="+1"><b><font color="#993366">Welcome to Turist Log</font></b></font></h1></marquee>
      </form></div>
			  </div>
			<!---End-contact---->
			<div class="clear"> </div>
